...
'Plinio',
'Porfirio',
            'Primitivo', 'Prudencia', 'Prudencio', 'Pánfilo', 'Pía', 'Rafael', 'Raimundo', 'Raquel', 'Raúl', 'Rebeca',
            'Regina', 'Reina', 'Renata', 'Reyes', 'Reyna', 'Reynaldo', 'Ricardo', 'Rico', 'Rita', 'Roberta', 
            'Roberto', 'Rogelio', 'Rosa María', 'Rosalina', 'Rosalinda', 'Rosalva', 'Rosario', 'Rosaura', 'Roxana',
            'Ruth', 'Ruy', 'Sabas', 'Sabina', 'Salomé', 'Salomón', 'Salud', 'Salvador', 'Samuel', 'Sancho',
            'Sandra', 'Santiago', 'Santos', 'Sara', 'Sarita', 'Saturnina', 'Sebastian', 'Segismundo', 'Selena', 'Serafina',
